 ...
 * @author Usuario
 */
public class MapeadorUsuarioGestor implements Mapeador{

    Usuario usuario;
    
    public MapeadorUsuarioGestor(){}
    
    public MapeadorUsuarioGestor(Usuario u){
        this.usuario = u;
    }
    ...
    public ArrayList<String> getSqlsInsertar() {
        ...
        sqls.add( "INSERT INTO usuariogestor values (" + getOid() + ",'" + this.getUsuario().getUser()+ "','" +
    ...
    public ArrayList<String> getSqlsActualizar() {
        ArrayList<String> sqls =new ArrayList();
        sqls.add("UPDATE usuariogestor SET user='" + this.getUsuario().getUser()
    ...
    public ArrayList<String> getSqlsBorrar() {
        ArrayList<String> sqls = new ArrayList();
        sqls.add( "DELETE FROM usuariogestor WHERE oid = " + getOid());
        return sqls;
    }

    @Override
    public String getSqlSeleccionar() {
        return "SELECT * FROM usuariogestor ";
    }
